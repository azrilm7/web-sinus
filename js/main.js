...
ScrollReveal().reveal('.home .info .btn, .home .scroll-down', { delay: 200, origin: 'bottom'});
...
ScrollReveal().reveal('.skills-description, .services-description, .contact-card, .contact-left ', { delay: 300, origin: 'left' });
ScrollReveal().reveal('.service-card, .education, .portofolio .img-card', { delay: 400, origin: 'bottom', interval:200 });
